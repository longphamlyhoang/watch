...
{
    public partial class Seeding_Product_Category : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TradeMark = table.Column<string>(nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "categories",
                columns: new[] { "CategoryId", "CategoryName", "Description", "Picture", "Status" },
                values: new object[] { 1, "Đồng hồ nam", "Đồng hồ nam", "fas fa-alarm-clock", true });

            migrationBuilder.InsertData(
                table: "categories",
                columns: new[] { "CategoryId", "CategoryName", "Description", "Picture", "Status" },
                values: new object[] { 2, "Đồng hồ nữ", "Đồng hồ nữ", "fas fa-alarm-clock", true });
